    ...
    <ModuleTransition delay="0.16">
      <div id="anchor" v-show="recoShowModule" class="home-blog-wrapper">
        ...
        <div class="info-wrapper">
          <PersonalInfo/>
          <h4><i class="ms-Icon ms-Icon--FlameSolid"></i> {{homeBlogCfg.category}}</h4>
          ...
          <hr>
          <h4 v-if="$tags.list.length !== 0"><i class="ms-Icon ms-Icon--Label"></i> {{homeBlogCfg.tag}}</h4>
          <TagList @getCurrentTag="getPagesByTags"/>
          <h4 v-if="$themeConfig.friendLink && $themeConfig.friendLink.length !== 0"><i
            class="ms-Icon ms-Icon--People"></i> {{homeBlogCfg.friendLink}}</h4>
          <FriendLink/>
        </div>
      </div>
    </ModuleTransition>
